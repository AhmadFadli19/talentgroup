    ...
    <body class="bg-gray-100 p-6">
        <div class="max-w-3xl mx-auto bg-white p-6 rounded shadow">
            ...
            <form method="POST" action="{{ route('bannercard.detail.submit', $BannerCard->id) }}" class="space-y-4">
                @csrf
                ...
                <div class="flex gap-4">
                    ...
                    <a href="{{ url('/' . $BannerCard->id) }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded">
                        Lihat Preview
                    </a>
                </div>
            </form>
